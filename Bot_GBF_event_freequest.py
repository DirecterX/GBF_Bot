...
#            Function.Summon_OK()          
        elif pyautogui.locateOnScreen('Pic/attack_free_event.png',region=(1673,403,246,200))!=None: #Attack
            if attack == True:
                Function.Battle_Attack(pyautogui.locateOnScreen('Pic/attack_free_event.png',region=(1673,403,246,200)))        
                attack = False
            #print('Click "Attack"')              
       ...
       ##Event Spaghetti Syndrome     
        elif pyautogui.locateOnScreen('Pic/free_event.png',region=(1508,816,211,164))!=None:
            #pyautogui.click(1610,750)  #Raid Battle    
            pyautogui.click(pyautogui.locateOnScreen('Pic/free_event.png',region=(1508,816,211,164)))  #Free Quest
       #Raid Battle
