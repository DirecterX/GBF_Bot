...
#            Function.Summon_OK()
        elif pyautogui.locateOnScreen('Pic/atkicon.png',region=(1335,239,200,300),confidence=0.8)!=None:
            pyautogui.click(pyautogui.locateOnScreen('Pic/atkicon.png',region=(1335,239,200,300),confidence=0.75))
            #katalina = True        
       ...
       # elif pyautogui.locateOnScreen('Pic/full.png',region=(1402,439,151,146))!=None: 
           ...
           # time.sleep(32)
        ...
        elif pyautogui.locateOnScreen('Pic/expgain.png',region=(1536,200,300,400))!=None: #EXP Gain
            ...
            attack = True
            auto_atk = True
        elif pyautogui.locateOnScreen('Pic/playagain.png',region=(1409,509,200,200),confidence=0.995)!=None: #Play Again
            Function.Finish_PLAYAGAIN(pyautogui.locateOnScreen('Pic/playagain.png',region=(1409,509,242,96),confidence=0.995))
        elif pyautogui.locateOnScreen('Pic/halonm.png',region=(1528,310,235,85),confidence=0.75)!=None:#Halo Nightmare Appeared
            Function.HALO_NM()
        ...
        elif pyautogui.locateOnScreen('Pic/useitem.png',region=(1494,271,300,300),confidence=0.75)!=None:
        ...
        #Event Finish
            ...
            pyautogui.click(pyautogui.locateOnScreen('Pic/ok.png',region=(curclick[0]-100,curclick[1],200,600),confidence=0.75))
       ...
       #Raid Battle
        ...
        #UandF Raid
            ...
            pyautogui.click(pyautogui.locateOnScreen('Pic/ok.png',region=(1500,450,300,400),confidence=0.75))
        elif pyautogui.locateOnScreen('Pic/water/proceed.png',region=(1485,232,300,300),confidence=0.8)!=None:
            pyautogui.click(pyautogui.locateOnScreen('Pic/water/lv90.png',region=(1413,513,250,350),confidence=0.8))
        elif pyautogui.locateOnScreen('Pic/event/UandF/prestige.png',region=(1410,864,450,400),confidence=0.85)!=None:
            curclick = pyautogui.locateOnScreen('Pic/event/UandF/prestige.png',region=(1410,864,450,400),confidence=0.85)
            pyautogui.click(curclick)
            time.sleep(1.5)
