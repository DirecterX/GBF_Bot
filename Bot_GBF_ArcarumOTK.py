...
atkIcon = True
SetUseSummon = False # wanna Use Summon
 
NoSummon = 1
SummonFirst = True # Use Summon First then Use Skill ?
setup = True #SeUpAttack
...
while Game_Detect: 
    try:
        ...
        #Arcarum Party Select
            ...
            time.sleep(0.3)
        #Arcarum Mission
        elif pyautogui.locateOnScreen('Pic/Arcarum_Mission.png',region=(x+200,y+200,x+450,y+400),confidence=0.85)!=None:
            time.sleep(0.1)
            pyautogui.click(pyautogui.locateOnScreen('Pic/Acarum_Mission_OK.png',region=(x+200,y+500,x+450,y+800),confidence=0.9))
            time.sleep(0.3)
        #Arcarum GuideBook Unlock
        elif pyautogui.locateOnScreen('Pic/Arcarum_GuideBook.png',region=(x+200,y+300,x+450,y+500),confidence=0.85)!=None:
            time.sleep(0.1)
            pyautogui.click(pyautogui.locateOnScreen('Pic/Acarum_Mission_OK.png',region=(x+200,y+500,x+450,y+800),confidence=0.9))
            time.sleep(0.3)    
        #Attack Section
