...
#            Function.Summon_OK()          
       ...
       #Raid Battle
        ...
        #Xeno Select Quest
        elif pyautogui.locateOnScreen('Pic/event/Xeno/Corrow/CorowLoop.png',region=(1414,350,470,608),confidence=0.85)!=None:         
            pos = pyautogui.locateOnScreen('Pic/event/Xeno/Corrow/CorowLoop.png',region=(1414,350,470,608),confidence=0.85)
            pyautogui.click(pyautogui.locateOnScreen('Pic/playevent.png',region=(pos[0],pos[1],500,300),confidence=0.85))
            SelectQuest = True 
        elif pyautogui.locateOnScreen('Pic/event/Xeno/Corrow/CorowClash.png',region=(1414,387,470,608),confidence=0.9)!=None:
            if SelectQuest == True:
