...
#            Function.Summon_OK()          
        elif pyautogui.locateOnScreen('Pic/attack_raid_event.png',region=(1673,403,246,200))!=None: #Attack
            if attack == True:
                Function.Battle_Attack(pyautogui.locateOnScreen('Pic/attack_raid_event.png',region=(1673,403,246,200)))        
                attack = False
            #print('Click "Attack"')              
